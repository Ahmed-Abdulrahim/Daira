        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FollowingId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETUTCDATE()")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetType = table.Column<string>(type: "nvarchar(20)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "idx_followers_following_id",
                table: "Followers",
                column: "FollowingId");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_friendships_addressee_id",
                table: "Friendships",
                column: "AddresseeId");

            migrationBuilder.CreateIndex(
                name: "idx_friendships_requester_id",
                table: "Friendships",
                column: "RequesterId");
            ...
            migrationBuilder.CreateIndex(
                name: "idx_notifications_user_isread_created",
                table: "Notifications",
            ...
            migrationBuilder.CreateIndex(
                name: "idx_refreshtokens_user_id",
                table: "RefreshTokens",
                column: "UserId");
        }
